...
- **Multimodal Standard**: Always use the `app.multimodal` package (processor and capabilities) for handling images and audio. Do not use legacy utilities in `app.utils`.
